...
if(isset($_SESSION["servi"])){/*PREGUNTA SI EXISTE LA SESSION*/
    $servi = $_SESSION["servi"];/*IGUAL LA SESION A LA VARIABLE misvis*/
    unset($_SESSION["servi"]);/*Y BORRAS LA SESSION*/
}else{
    header('Location: php/controller/servicio.controller.php?op=1');/*CASO CONTRARIO REDIRECCIONAS AL CONTROLLADOR PARA CREAR UNA SESION*/
}
?>
<!DOCTYPE html>
        ...
        <section id="main">
            <aside id="sidebar">
                <div class="sidebar-inner c-overflow">
                    ...
                    <ul class="main-menu">
                        <li><a href="index.php"><i class="md md-dashboard"></i> Panel de Control</a></li>
                        <li><a href="admin-mision.php"><i class="md md-work"></i> Mision</a></li>                        
                        <li><a href="admin-nosotros.php"><i class="md md-people"></i> Nosotros</a></li>
                        <li class="active"><a href="admin-servicios.php"><i class="md md-notifications"></i>Servicios</a></li>
                    </ul>
                </div>
            </aside>
                        ...
                        <div class="col-sm-12"> 
                           <div class="card" id="">
                                <div class="card-header">
                                    <h2>Modificacion de Servicio</h2>
                                </div>
                                <div class="card-body card-padding">
                                    <form role="form" id="formserv">
                                        <div class="form-group fg-line">
                                            <label for="exampleInputEmail1">Título del Servicio</label>
                                             <input name="titu" required type="text" class="form-control" placeholder="Nombre" value="<?php echo $servi[0]->tit; ?>">
                                        </div>
                                        <div class="form-group fg-line">
                                            <label for="exampleInputEmail1">Descripcion</label>
                                            <div class="fg-line">
                                            <textarea name="cuerpo" required id="editor1" class="ckeditor form-control" rows="10" cols="80">
                                                <?php echo $servi[0]->cue; ?>
                                            </textarea> <!--VOY A PEDIR EL NOMBRE DE LA COLUMNA: cue -->                                                  
                                            </div>                                    
                                        </div>
                                        <div class="form-group fg-line">
                                            <label for="exampleInputEmail1">Imagen del Servicio</label>
                                             <input name="img" required type="file" class="form-control" placeholder="Nombre">
                                                <?php echo $servi[0]->img; ?><!--VOY A PEDIR EL NOMBRE DE LA COLUMNA: img -->
                                             </input>
                                        </div>                                
                                        <button type="submit" onclick="CKupdate();" class="btn btn-primary btn-sm m-t-10 waves-effect">Modificar</button>
                                        <a onclick=""  class="btn btn-danger btn-sm m-t-10 waves-effect">Cancelar</a>
                                    </form>
                                </div>
                            </div>
                        </div>
