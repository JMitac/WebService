...
if(isset($_SESSION["nosotros"])){/*PREGUNTA SI EXISTE LA SESSION*/
    $nosotros = $_SESSION["nosotros"];/*IGUAL LA SESION A LA VARIABLE nosotros*/
    unset($_SESSION["nosotros"]);/*Y BORRAS LA SESSION*/
}else{
    header('Location: php/controller/nosotros.controller.php?op=1');/*CASO CONTRARIO REDIRECCIONAS AL CONTROLLADOR PARA CREAR UNA SESION*/
}
            ...
            <aside id="sidebar">
                <div class="sidebar-inner c-overflow">
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="active"><a href="admin-nosotros.php"><i class="md md-people"></i> Nosotros</a></li>
                                    ...
                                    -->
                                        <div class="form-group fg-line">
                                            ...
                                            <textarea name="cuerpo" required id="editor1" class="ckeditor form-control" rows="10" cols="80">
                                                <?php echo $nosotros[0]->cue; ?><!--VOY A PEDIR EL NOMBRE DE LA COLUMNA: cue -->
                                            </textarea>                                                   
                                            </div>                                    
                                        </div>
                                        <!--
